        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <img src="{{ asset('img/usa_o_void_invest.png') }} " alt="" width="220px" >
                </a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="img/usa_o_void_invest.png" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Jhon send you a message</h6>
                                        <small>15 minutes ago</small>
                                    </div>
                        ...
                        <table class="table table-dark table-striped mb-0">
                            <thead>
                                <tr class="text-white">
                                    ...
                                    <th scope="col">Fechamento Anterior</th>
                                    <th scope="col">mais alto</th>
                                    <th scope="col">mais baixo</th>
